...
function CreateSM(){
    ...
    const Submit = (m) =>{
        m.preventDefault()
        axios.post("http://localhost:3001/CreateSM" , {code,date,mqty,cqty,type})
            .then(result => {
                console.log(result)
                navigateSM('/stocksSM')   //submit link to the user page
            })
                    ...
                    <div style={{
                        ...
                        <div style={{flex: 1, padding: "20px", backgroundColor: "#f8f8f8"}}>
                            ...
                            <form onSubmit={Submit}
                                ...
                                <div style={{marginBottom: "10px", display: "flex", alignItems: "center"}}>
                                    <label htmlFor="date"
                                           style={{width: "130px", marginRight: "10px", fontWeight: '700'}}>Date</label>
                                ...
                                <div style={{marginBottom: "10px", display: "flex", alignItems: "center"}}>
                                    <label htmlFor="namem" style={{
                                        ...
                                        marginRight: "10px",
                                        fontWeight: '700'
                                    }}>Moved Quantity(kg)</label>
                                    <input type="text" placeholder='Enter moved Quantity' className='form-control'
                                           style={{width: "100%", padding: "8px", margin: "5px 0 15px"}}
                                           onChange={(e) => setmqty(e.target.value)}></input>
                                </div>
                                ...
                                <div style={{marginBottom: "10px", display: "flex", alignItems: "center"}}>
                                    <label htmlFor="namem" style={{
                                        ...
                                        marginRight: "10px",
                                        fontWeight: '700'
                                    }}>Current Quantity(kg)</label>
                                    <input type="text" placeholder='Enter current Quantity' className='form-control'
                                           style={{width: "100%", padding: "8px", margin: "5px 0 15px"}}
                                           onChange={(e) => setcqty(e.target.value)}></input>
                                </div>
