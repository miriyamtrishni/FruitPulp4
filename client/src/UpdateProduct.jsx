...
function UpdateProduct (){
    ...
    const Update = (e) => {
        e.preventDefault();
        axios.put("http://localhost:3001/updateProduct/"+id, {fruittype,manufacturedate,expiredate,quantity,price})
        .then(result => {
            console.log(result)
      ...
      >
        ...
        <div style={{ flex: 1, padding: "20px", backgroundColor: "#f8f8f8" }}>
             ...
             <form onSubmit={Update} style={{ display: "flex", flexDirection: "column", justifyContent: "center" }}>
                 ...
                 <div style={{ marginBottom: "2px", display: "flex", alignItems: "center" }}>
                 <label htmlFor="expiredate" style={{ width: "130px", marginRight: "10px",fontWeight: '700' }}>ExpireDate</label>
                  <input 
                         type="date" 
                         ...
                         style={{ width: "100%",padding: "8px", margin: "5px 0 15px" }} 
                           ...
                           value= {expiredate}  onChange={(e) => setExpireDate((e.target.value))} required />
                 ...
                 <div style={{ marginBottom: "2px", display: "flex", alignItems: "center" }}>
                     <label htmlFor="price" style={{width: "130px", marginRight: "10px",fontWeight: '700' }}>Price</label>
                     <input type="text" placeholder="Enter price" className="form-control" style={{ width: "100%",padding: "8px", margin: "5px 0 15px" }} 
