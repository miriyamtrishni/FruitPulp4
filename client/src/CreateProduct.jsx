...
function CreateProduct (){
    ...
    const Submit = (e) => {
        e.preventDefault();
        axios.post("http://localhost:3001/createProduct", {fruittype,manufacturedate,expiredate,quantity,price})
        .then(result => {
            console.log(result)
...
<div style={{display: "flex", justifyContent: "center", alignItems: "center", minHeight: "100vh",padding: "16px" ,fontFamily: 'Poppins, sans-serif',backgroundColor:"#FEF29B" }}>
        ...
        <div style={{ flex: 1, padding: "20px", backgroundColor: "#f8f8f8" }}>
                ...
                <form onSubmit={Submit} style={{ display: "flex", flexDirection: "column", justifyContent: "center" }}>
                    ...
                    <div style={{ marginBottom: "2px", display: "flex", alignItems: "center" }}>
                    <label htmlFor="expiredate" style={{width: "200px", marginRight: "10px",fontWeight: '700'}}>ExpireDate</label>
                     <input 
                            type="date" 
                    ...
                    <div style={{ marginBottom: "2px", display: "flex", alignItems: "center" }}>
                        <label htmlFor="price" style={{  width: "200px", marginRight: "10px",fontWeight: '700' }}>Price</label>
